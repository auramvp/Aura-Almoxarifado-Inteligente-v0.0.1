...
import { AlertTriangle, TrendingDown, PackageCheck, Building2, Loader2, Sparkles, History, ArrowUpRight, ArrowDownRight, Package, Wallet, TrendingUp 
} from 'lucide-react';
          ...
          <div className="h-80 w-full">
            {stats.topItemsByCost && stats.topItemsByCost.length > 0 ? (
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={stats.topItemsByCost} layout="vertical" margin={{ left: 40, right: 20 }}>
