    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button onClick={() => setIsAnalysisOpen(!isAnalysisOpen)} className={"flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-blue-700 hover:text-white transition font-bold border shadow-sm " + (isAnalysisOpen ? 'bg-blue-600 text-white border-blue-600' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-700')}><BarChart3 size={18} /> Análise</button>
          {canEdit && (
            <>
